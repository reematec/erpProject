{
    ...
    'data': [
        ...
        'data/reema_fg_location_data.xml',
        ...
        'views/reema_consumable_stock_take_views.xml',
        'views/reema_ilo_views.xml',
        'views/reema_packing_list_views.xml',
        'views/reema_packing_list_report.xml',
        'views/reema_box_packing_list_views.xml',
        'views/reema_box_packing_list_report.xml',
        'views/reema_commercial_invoice_views.xml',
        'views/reema_commercial_invoice_report.xml',
